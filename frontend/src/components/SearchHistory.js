...
const SearchHistory = ({ history }) => {
  ...
  const toggleExpand = e => {
    ...
    return !showResults ? e.target.parentElement.classList.add('expand') : e.target.parentElement.classList.remove('expand');
  }

  return(
    <tr className="table-data" onClick={e => toggleExpand(e)}>
